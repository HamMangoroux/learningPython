...
public class VaultDoor8 {
    ...
    public boolean checkPassword(String password) {
        ...
        char[] expected = {0xF4, 0xC0, 0x97, 0xF0, 0x77, 0x97, 0xC0, 0xE4, 0xF0, 0x77,
                           0xA4, 0xD0, 0xC5, 0x77, 0xF4, 0x86, 0xD0, 0xA5, 0x45, 0x96, 
                           0x27, 0xB5, 0x77, 0xD2, 0xD0, 0xB4, 0xE1, 0xC1, 0xE0, 0xD0, 
                           0xD0, 0xE0};

        /* f4 c0 97 f0 77 97 c0 e4 f0 77 a4 d0 c5 77 f4 86 d0 a5 45 96 27 b5 77 d2 d0 b4 e1 c1 e0 d0 d0 e0 */
